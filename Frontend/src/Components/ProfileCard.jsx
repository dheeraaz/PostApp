...
const ProfileCard = ({ setIsProfileModalOpen, setIsCoverModalOpen, postCount, profileId, userInfo }) => {
    ...
    return (
        <div className='mb-2 max-w-[90%] w-[600px] mx-auto bg-_primary rounded-md shadow-md pt-4 px-4 pb-6'>
            <div className='w-full h-[200px] rounded-md relative'>
                <img src={userInfo?.coverpic || userDetails.coverpic} alt="" className='w-full h-full object-cover rounded-md ' />

                {profileId === userDetails._id && <div className='absolute bottom-2 right-2'>
                ...
                <div className='absolute -bottom-8 left-4 w-24 h-24 rounded-full p-[2px] bg-gray-400'>
                    <img src={userInfo?.profilepic || userDetails.profilepic} alt="prfile_img" className='w-full h-full rounded-full bg-gray-700 object-cover' />

                    {profileId === userDetails._id && <div className='absolute bottom-0 right-0'>
