        ...
        <div className='mb-2 max-w-[90%] w-[600px] mx-auto bg-_primary rounded-md shadow-md pt-4 px-4 pb-6'>
            <div className='w-full h-[200px] rounded-md relative'>
                ...
                <div className='absolute bottom-2 right-2'>
                    <button className='bg-gray-500 p-2 flex gap-2 items-center rounded-md font-_roboto hover:bg-gray-400'><FaCamera size={18} /> <p>Add New Photo</p></button>
                </div>

                <div className='absolute -bottom-8 left-4 max-w-24 max-h-24 rounded-full p-[2px] bg-gray-400'>
                    <img src={userDetails.profilepic} alt="prfile_img" className='w-full h-full rounded-full bg-gray-700' />

                    <div className='absolute bottom-0 right-0'>
                        <button className='bg-gray-500 p-[6px] rounded-full hover:bg-gray-400'><FaCamera size={18} /></button>
                    </div>
                </div>
            </div>
